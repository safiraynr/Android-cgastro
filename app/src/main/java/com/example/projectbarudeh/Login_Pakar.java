...
public class Login_Pakar extends AppCompatActivity  implements View.OnClickListener {
    //deklarasi beberapa variabel kayak button editext, databaserefrence, firebaseauth
    private static final String TAG = "Login_Pakar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login__pakar);
...
//        btnKeluar.setOnClickListener(this);
    ...
    /*private void showData(DataSnapshot dataSnapshot) {
        for (DataSnapshot ds : dataSnapshot.getChildren()){
            pakar_info pinfo = new pakar_info();
            pinfo.setNama(ds.child(userID).getValue(pakar_info.class).getNama());

            Log.d(TAG, "showData: nama: "+ pinfo.getNama());

            ArrayList<String> array = new ArrayList<>();

            array.add(pinfo.getNama());
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Login_Pakar.this, "Sign In Failed",
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Login_Pakar.this, "Sign Up Failed",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        hmm = user.getUid();
        // Go to MainActivity
        // var hmm buat get user id
        Toast.makeText(Login_Pakar.this, hmm,
                Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Login_Pakar.this, Akun_Pakar.class));
        finish();
    }
    ...
    private void writeNewAdmin(String userId, String name, String email) {
        ...
        mDatabase.child("pakar").child(userId).setValue(loginModel);
    }
    ...
    public static Intent getActIntent(Activity activity) {
        ...
        return new Intent(activity, Login_Pakar.class);
    }
}
